...
export default function ProjectSection({ projects, platformImage }: { projects: Projects; platformImage: string }) {
  return (
    <section id="projects" className="content-section projects-section">
      <div className="section-heading"><div className="section-marker"><span>01</span><img className="section-node" src="/manus-storage/marco-signal-logo_ff8cb29d.png" alt="" /><i /><strong>{projects.marker}</strong></div><div><h2>{projects.heading[0]}<br /><i>{projects.heading[1]}</i></h2><p>{projects.intro}</p></div></div>
